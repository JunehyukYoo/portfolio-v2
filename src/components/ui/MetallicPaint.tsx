...
export default function MetallicPaint({
  ...
  console.log("Uploading texture:", imageData.width, imageData.height);
  ...
  useEffect(() => {
    ...
    function initShader() {
      ...
      console.log("Vertex shader compiled:", vertexShader != null);
      console.log("Fragment shader compiled:", fragmentShader != null);
      console.log("Program linked:", program != null);
      console.log("Attrib/buffer set");
      startRenderLoop();
    }
  ...
  useEffect(() => {
    if (
      !glRef.current ||
      !uniformsRef.current ||
      !uniformsRef.current.u_image_texture
    )
      return;
    updateUniforms();
  }, [glRef, params, uniformsRef]);
  ...
  }, [glRef, uniformsRef, imageData]);

  useEffect(() => {
    const gl = glRef.current;
    const uniforms = uniformsRef.current;
    if (!gl || !uniforms || !uniforms.u_image_texture) return;
  ...
  return (
    <canvas
      ...
      style={{
        ...
        border: "4px solid limegreen", // visibility
        background: "black",
      }}
